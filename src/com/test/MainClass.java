...
public class MainClass {
	...
	public static void main(String[] args) throws FileNotFoundException {
		// scanner类是获取用于输入的数据用的.
		Scanner scanner = new Scanner(System.in);
		System.out.println("欢迎你使用恶搞大王制作的文件和文件夹数量查询器");
		System.out.println("如果您的文件和文件夹数量较多.可能要花费一定的时间");
		System.out.println("具体的时间根据你的电脑性能和相应的文件和文件夹的数量决定");
		while (flag) {
